...
# Every page on the site, for the Ctrl/Cmd+K quick-jump palette.
# (icon, title, one-line description, href, group)
PAGES_DATA = [
    ("🏠", "Home", "Free-roam entry point and site overview", "index.html", "Start"),
    ("🎓", "8-Lesson Course", "The same material, sequenced with worksheets", "course.html", "Start"),
    ("🌍", "What Is Global Warming?", "The greenhouse effect, explained simply", "what-is-global-warming.html", "Learn"),
    ("🏭", "Causes", "What is actually filling the atmosphere, ranked", "causes.html", "Learn"),
    ("🌊", "Effects", "Worldwide impacts, and Nigeria's 2025 floods and heat", "effects.html", "Learn"),
    ("❤️", "Why Should We Care?", "Climate justice and why it matters close to home", "why-care.html", "Learn"),
    ("🧮", "Carbon Footprint Calculator", "Estimate your own footprint in two minutes", "carbon-footprint.html", "Take Action"),
    ("♻️", "Reduce, Reuse, Recycle", "The three Rs, in the order that matters", "recycle.html", "Take Action"),
    ...
    ("2️⃣", "Lesson 2", "What causes global warming", "lesson-2.html", "Course"),
    ("3️⃣", "Lesson 3", "Effects, worldwide and at home", "lesson-3.html", "Course"),
    ("4️⃣", "Lesson 4", "Why we should care", "lesson-4.html", "Course"),
    ("5️⃣", "Lesson 5", "Your carbon footprint", "lesson-5.html", "Course"),
    ("6️⃣", "Lesson 6", "Reduce, reuse, recycle", "lesson-6.html", "Course"),
    ("7️⃣", "Lesson 7", "Clean energy", "lesson-7.html", "Course"),
    ("8️⃣", "Lesson 8", "Taking action", "lesson-8.html", "Course"),
    ("🏆", "Certificate", "Download a Certificate of Completion", "certificate.html", "Course"),
    ("📮", "Check In", "Send your progress to your teacher on GitHub", "checkin.html", "Course"),
    ("📋", "Class Dashboard", "Auto-updating roster of student check-ins", "class-dashboard.html", "Course"),
    ("🧑‍🏫", "For Teachers", "Lesson plan, pacing guide and setup", "for-teachers.html", "Course"),
    ("👤", "About", "Meet Babatunde Awoyemi and Techbase", "about.html", "About"),
]
...
PAGES_JSON = json.dumps(
    [{"icon": i, "title": t, "desc": d, "href": h, "group": g} for i, t, d, h, g in PAGES_DATA]
)
...
HEADER_TOOLS_HTML = """<div class="header-tools">
        <button class="icon-btn palette-btn" id="palette-btn" aria-label="Search pages" aria-keyshortcuts="Control+K">
          ...
          <span class="pb-label">Jump to</span><kbd>Ctrl K</kbd>
        </button>
        <button class="icon-btn theme-toggle" id="theme-toggle" aria-label="Toggle dark mode">
          ...
          <svg class="ico-moon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
        </button>
      </div>"""

BACK_TO_TOP_HTML = """<button class="back-to-top" id="back-to-top" aria-label="Back to top">
...
PALETTE_HTML = """<div class="palette-backdrop" id="palette-backdrop">
  <div class="palette" role="dialog" aria-modal="true" aria-label="Jump to page">
    <div class="palette-input-row">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
      <input type="text" id="palette-input" placeholder="Jump to any page..." autocomplete="off" spellcheck="false">
      <span class="palette-esc">ESC</span>
    </div>
    <div class="palette-results" id="palette-results"></div>
  </div>
</div>
<script>window.SITE_PAGES = %s;</script>""" % PAGES_JSON
...
def nav_html(active):
    ...
    <nav class="nav" aria-label="Primary">
      ...
      <div class="nav-cta">
        ...
        <button class="menu-btn" id="menu-btn" aria-label="Open menu" aria-expanded="false" aria-controls="mobile-menu"><span></span></button>
      </div>
    </nav>
...
home_hero = hero_block(
    ...
    h1="One atmosphere. One planet. Every degree counts, including at home.",
  ...
  <div class="wrap">
    <div class="grid grid-2 reveal">
      <div class="card" style="border-color:var(--teal-500);">
        ...
        <p>Jump straight into whatever pulls you in, the cards below, organised by theme, no set sequence.</p>
      ...
      <div class="card" style="border-color:var(--amber-500);">
        ...
        <p>The same material, sequenced with objectives, printable worksheets, and a completion certificate at the end. Built for classrooms, great solo too.</p>
...
<section class="section">
  <div class="wrap">
    <div class="section-head reveal">
      ...
      <p class="lede">Three ways in: understand what's actually happening, see what it means close to home, then do something about it. Jump to whatever pulls you in, there's no wrong door.</p>
    </div>
    ...
    <div class="explore-group reveal">
      ...
      <div class="grid grid-4">
        ...
        <a class="card" href="causes.html"><div class="ico">🏭</div><span class="tag">Source</span><h3>Causes</h3><p>What's actually filling the atmosphere, ranked by how much each one matters.</p><span class="card-link">Read</span></a>
        <a class="card" href="effects.html"><div class="ico">🌊</div><span class="tag">Impact</span><h3>Effects</h3><p>Melting ice, fiercer storms, and the floods that hit Nigeria hard in 2025.</p><span class="card-link">Read</span></a>
    ...
    <div class="explore-group reveal">
      ...
      <div class="grid grid-4">
        ...
        <a class="card" href="action-hub.html"><div class="ico">✅</div><span class="tag">Checklist</span><h3>Action Hub</h3><p>Real actions for school, home and your community, tick them off as you go.</p><span class="card-link">Open hub</span></a>
      </div>
    </div>
    ...
    <div class="explore-group reveal">
      ...
      <div class="grid grid-3">
        ...
        <a class="card" href="quiz.html"><div class="ico">🎯</div><span class="tag">10 questions</span><h3>Quiz</h3><p>Test what you've picked up, built for explorers of every age.</p><span class="card-link">Play</span></a>
        <a class="card" href="glossary.html"><div class="ico">📖</div><span class="tag">A to Z</span><h3>Glossary &amp; Sources</h3><p>Every tricky term explained simply, plus where all the numbers come from.</p><span class="card-link">Look up</span></a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div class="layout-2col reveal">
      <div>
        ...
        <p>This guide started life years ago as a presentation built for a student. It's now been rebuilt from scratch by <strong>Babatunde Ayoola Awoyemi</strong>, a physicist, STEM educator, and Lead Consultant at <strong>Techbase Consultant Services</strong> in Ibadan, Nigeria, as a free, open learning tool for anyone curious about the warming world we live in.</p>
...
what_hero = hero_block(
    ...
    lede="Strip away the politics and the panic for a second: global warming is a physics problem. It's about what happens to heat once sunlight reaches Earth, and why a thin layer of gas, measured in parts per million, makes such an outsized difference.",
  ...
  <div class="wrap">
    <div class="layout-2col">
      <div class="prose reveal">
        ...
        <ul>
          <li><strong>Weather</strong> is what's happening outside right now, today's rain, today's heat.</li>
          <li><strong>Climate</strong> is the long-term pattern of weather in a place, usually averaged over 30 years.</li>
          <li><strong>Global warming</strong> is the measured rise in Earth's average surface temperature over decades, caused mainly by human-added greenhouse gases, one driver reshaping climates everywhere, at different speeds and in different ways.</li>
        </ul>
        <p>A cold week somewhere doesn't disprove global warming any more than one hot afternoon proves it. It's the decades-long average that matters, and that average keeps climbing.</p>

        <h2 style="margin-top:1.6em;">Why a few hundred parts per million matters so much</h2>
        <p>"Parts per million" (ppm) sounds tiny, and in one sense it is: CO2 is still a small slice of the atmosphere, which is mostly nitrogen and oxygen. But greenhouse gases are disproportionately powerful at trapping heat for their size. Atmospheric CO2 has risen from about 280 ppm before the Industrial Revolution to roughly 427 ppm in 2025, about a 50%% increase, and each extra molecule adds a little more trapped heat across the entire planet, all the time.</p>
        <div class="callout callout--try">
          <span class="callout-label">Try this · A 10-minute experiment</span>
          <p>Place two thermometers in the sun: one inside a clear sealed jar, one left in the open air. Check both after 20 to 30 minutes. The jar traps heat the way greenhouse gases do; it almost always reads warmer. Scale that idea up to an entire planet, and you've got the core of this whole topic.</p>
        </div>
      </div>
...
<section class="section">
  <div class="wrap">
    <div class="section-head reveal">
      ...
      <p class="lede">This list is genuinely a ranking: it follows roughly how much each sector contributes to global human-caused greenhouse gas emissions, based on international energy and climate accounting.</p>
    </div>
    <ol class="numbered-list reveal">
      ...
      <li>
        ...
        <p>Clearing forests removes carbon-storing trees and often releases the carbon stored in soil. Livestock farming adds methane; fertiliser use adds nitrous oxide, both far more potent than CO2 molecule-for-molecule.</p>
      </li>
      <li>
        <h3>Waste</h3>
    ...
    <div class="fact-strip reveal">
      ...
      <div class="fact"><div class="fv">2.6</div><div class="fl">Average annual ppm increase, 2015 to 2024</div></div>
    </div>
    %s
  </div>
</section>
...
<section class="section">
  <div class="wrap">
    ...
    <div class="grid grid-3 reveal">
      <div class="card"><div class="ico">🌡️</div><h3>Rising temperatures</h3><p>2025 was Earth's third-warmest year on record, about 1.3°C above the 1850 to 1900 average. The ten warmest years on record have all occurred since 2015.</p></div>
      ...
      <div class="card"><div class="ico">🌪️</div><h3>Fiercer weather</h3><p>Warmer air holds more moisture and warmer oceans fuel stronger storms, 2025 saw 101 named storms worldwide, above the recent average of 88.</p></div>
      <div class="card"><div class="ico">🌊</div><h3>Warming, more acidic oceans</h3><p>Oceans absorb most of the planet's extra heat. 2025 was the fifth straight year of record-high upper-ocean heat content, bad news for coral reefs and fisheries.</p></div>
      ...
      <div class="card"><div class="ico">🦋</div><h3>Pressure on ecosystems</h3><p>Species are shifting ranges, breeding times and migration patterns, some faster than ecosystems around them can adjust.</p></div>
    </div>
  </div>
</section>
...
<section class="section section--alt">
  <div class="wrap">
    ...
    <div class="callout callout--alert reveal">
      ...
      <p>None of this means Nigeria caused the problem: the country's historic contribution to global emissions is small. But geography and economics mean the impacts land hard anyway. That tension is exactly what the next page digs into.</p>
    </div>
    %s
  </div>
</section>
...
why_hero = hero_block(
    ...
    lede="Because every system that feeds, waters, houses and employs people leans on a climate that's now shifting under it, and because the people who've contributed least to the problem are often the ones absorbing the most risk.",
  ...
  <div class="wrap">
    <div class="grid grid-2 reveal" style="margin-bottom:30px;">
      ...
      <div class="card">
        <div class="ico">💼</div>
        <h3>Economy &amp; jobs</h3>
        <p>Damaged farmland, disrupted supply chains and rebuilding costs after disasters all weigh on growth, money that could otherwise go toward schools, hospitals and infrastructure.</p>
      </div>
      <div class="card">
        <div class="ico">🦓</div>
        <h3>Biodiversity</h3>
      ...
      <div class="card">
        ...
        <p>Today's children will live through more decades of accumulating change than anyone reading this, which is exactly why this site is built to make sense to them too.</p>
      </div>
    </div>
    ...
    <div class="layout-2col">
      <div class="prose reveal">
        ...
        <p>Here's the part that doesn't get said often enough: Africa as a whole has contributed a small share of the greenhouse gases that built up in the atmosphere since the Industrial Revolution. Nigeria's own historic emissions are modest by global standards. Yet the impacts, floods like Mokwa, heat stress across the north, coastal erosion in Lagos, land hard, because so much of the economy and so many livelihoods depend directly on stable rainfall, farmland and coastlines.</p>
        ...
        <p>It's also exactly why local knowledge, local adaptation, and a new generation of African scientists, engineers and educators matter so much: this isn't a problem anyone elsewhere is going to solve <em>for</em> Nigeria. It has to be understood, and acted on, from here too.</p>
      </div>
      <aside class="side-card">
        <h4>One honest caveat</h4>
        <p style="font-size:.88rem;">These figures (WHO heat-related mortality estimate, global vulnerability count) are widely cited international estimates, not exact counts; real-world impacts are hard to measure precisely. Treat them as "this is roughly the scale we're talking about," not a perfectly exact tally.</p>
      </aside>
    </div>
    %s
  </div>
...
cfp_hero = hero_block(
    ...
    lede="A carbon footprint adds up the greenhouse gases linked to your everyday choices, mainly travel, electricity and food, into one rough number. This calculator gives you an honest estimate in about two minutes. It's a learning tool, not a scientific audit.",
    ...
    <div class="layout-2col">
        ...
        <form id="footprint-form" class="tool-panel">
          ...
          <div class="field">
            ...
            <div class="radio-row">
              ...
              <label><input type="radio" name="flights" value="short"> 1 to 2 short flights</label>
          ...
          <div class="field">
            ...
            <select name="electricity">
              <option value="low">Low, lights &amp; small appliances mainly</option>
              <option value="medium" selected>Medium, fridge, fans, regular appliances</option>
              <option value="high">High, AC, many appliances, large household</option>
            </select>
          </div>
          <div class="field">
      ...
      <div>
        ...
        <div class="callout callout--note" style="margin-top:20px;">
          ...
          <p>This is a simplified estimate using broad, illustrative factors, it's built to teach you which choices move the number most, not to be an exact personal audit. Transport distance, flights and generator use tend to shift it the most.</p>
        </div>
      </div>
    </div>
    %s
...
recycle_hero = hero_block(
    ...
    h1="Reduce, reuse, recycle, in that order",
    lede="The three Rs aren't interchangeable; they're a priority list. Reducing what you use in the first place beats reusing, which beats recycling, which still beats throwing away, and the order matters more than people realise.",
  ...
  <div class="wrap">
    <div class="grid grid-3 reveal">
      ...
      <div class="card">
        ...
        <div class="ico">♻️</div>
        <h3>Recycle</h3>
        <p>When something truly can't be reduced or reused further, recycling turns it back into raw material, using far less energy than mining or manufacturing from scratch.</p>
      </div>
    </div>
    ...
    <div class="layout-2col" style="margin-top:40px;">
      <div class="prose reveal">
        ...
        <ul>
          <li><strong>Paper &amp; cardboard</strong>, flatten boxes, keep them dry.</li>
          <li><strong>Plastic bottles &amp; containers</strong>, rinse out food residue first.</li>
          <li><strong>Glass &amp; metal cans</strong>, almost endlessly recyclable without losing quality.</li>
          <li><strong>Organic waste</strong> (peels, leftovers), compost where possible instead of binning it; it cuts landfill methane.</li>
          <li><strong>E-waste</strong> (batteries, old phones), never bin these; they need specialist handling.</li>
        </ul>
        <div class="callout callout--note">
          <span class="callout-label">The Nigeria angle</span>
          <p>Formal recycling infrastructure is still patchy in much of Nigeria, but a large informal economy of waste pickers and scrap dealers already recovers huge volumes of metal, plastic and paper for resale, an unglamorous but genuinely important climate contribution worth recognising.</p>
        </div>
      </div>
      <aside class="side-card">
        <h4>Try this at home or school</h4>
        <p style="font-size:.88rem;">Set up three labelled boxes for a week, Reduce candidates (things you almost didn't need), Reuse, and Recycle. At the end of the week, see which box filled up fastest. It usually says a lot.</p>
      </aside>
    </div>
"""
...
<section class="section">
  <div class="wrap">
    <div class="grid grid-3 reveal">
      <div class="card"><div class="ico">☀️</div><h3>Solar</h3><p>Photovoltaic panels turn sunlight directly into electricity. Costs have fallen so far, so fast, that solar is now the cheapest new electricity source in much of the world, including across Africa.</p></div>
      ...
      <div class="card"><div class="ico">💧</div><h3>Hydro, geothermal &amp; biomass</h3><p>Flowing water, underground heat, and organic material round out the renewable mix, each suited to different geographies and grids.</p></div>
    </div>
...
hub_hero = hero_block(
    ...
    h1="The Action Hub",
    lede="Reading about climate change is step one. This page is step two: a real, tickable list of things you can actually do at school, at home, and in your community, starting today.",
...
<section class="section">
  <div class="wrap">
    <div class="impact-meter reveal">
      ...
      <span class="muted">actions checked off, come back any time and keep going.</span>
    </div>
...
<section class="section">
  <div class="wrap">
    ...
    <div class="chart-card reveal">
      ...
      <p class="chart-meta">Global surface temperature anomaly vs. the 20th-century (1901 to 2000) average</p>
...
quiz_hero = hero_block(
    ...
    lede="Ten questions pulled straight from this guide, some easy, some sneaky. Built for explorers of every age. No score is saved anywhere; just play, learn, and try again whenever you like.",
...
glossary_hero = hero_block(
    eyebrow="Go further · A to Z",
    h1="Glossary &amp; sources",
    lede="Every tricky term used across this site, explained simply, plus where the numbers and facts actually came from.",
...
GLOSSARY_TERMS = [
    ...
    ("P", "Pre-industrial baseline", "Conditions before large-scale fossil fuel use began (roughly 1850 to 1900), used as the comparison point for how much warming has happened since."),
    ...
    <div class="layout-2col">
      ...
      <aside class="side-card">
        ...
        <ul style="display:grid;gap:14px;">
          <li><a href="https://science.nasa.gov/earth/explore/earth-indicators/global-temperature/" target="_blank" rel="noopener">NASA GISS: Global Temperature</a><br><span class="muted" style="font-size:.8rem;">Long-running global surface temperature analysis.</span></li>
          <li><a href="https://www.ncei.noaa.gov/" target="_blank" rel="noopener">NOAA NCEI: Global Climate Reports</a><br><span class="muted" style="font-size:.8rem;">Monthly and annual global climate summaries.</span></li>
...
about_hero = hero_block(
    ...
    lede="Physicist, STEM educator, and Lead Consultant at Techbase Consultant Services in Ibadan, Nigeria, and the person who built this whole guide, twice.",
  ...
  <div class="wrap">
    <div class="layout-2col">
      ...
      <div class="prose reveal">
        ...
        <p>My own background is in atmospheric physics, I studied how sunlight and heat move through the atmosphere, and how satellites like MODIS and CERES help us measure it from space. That's part of why this site leans on real instrument-style numbers wherever it can, rather than vague claims: it's how I was trained to think about the atmosphere in the first place.</p>
        <p>Outside of climate and physics, I run <strong>Techbase Consultant Services</strong>, where I work across IT consultancy, web development, robotics, and, closest to my heart, STEM education for young people across Nigeria. I also teach and help build curriculum at my church, and spend a fair amount of free time on photography, football, and long drives.</p>
        <h2 style="margin-top:1.2em;">A few other things I've built</h2>
        <div class="project-strip">
          <a href="https://babatundeawo.github.io/ai-prompt-library/" target="_blank" rel="noopener"><span>AI Prompt Library: 200+ curated, searchable prompts</span><span>↗</span></a>
          ...
          <a href="https://babatundeawo.github.io/career-engine-guide/" target="_blank" rel="noopener"><span>Personal AI Career Engine: a guided career-building system</span><span>↗</span></a>
          <a href="https://techbaseng.github.io/" target="_blank" rel="noopener"><span>Techbase STEM Academy: courses, Scratch &amp; robotics lessons</span><span>↗</span></a>
        </div>
        <a href="https://babatundeawo.github.io/" target="_blank" rel="noopener" class="btn btn-amber" style="margin-top:20px;width:100%;justify-content:center;">🔗 See everything I've built, My Portfolio →</a>
        <div class="callout callout--note" style="margin-top:28px;">
          <span class="callout-label">A note for whoever's reading this</span>
          <p>If you're a teacher, student, or just someone who stumbled in here, this site is free to use, copy and remix for learning. If it helps you explain climate change to someone else, it's done its job.</p>
        </div>
      </div>
    </div>
  </div>
...
LESSONS = [
    {
        ...
        "summary": """<p>Sunlight passes through the atmosphere easily and warms the ground. The warmed Earth radiates that energy back out as heat. Some heat escapes to space, but greenhouse gases like CO2 absorb part of it and send it back down, like a blanket holding body heat in.</p>
        <p>CO2 has risen from about 280 ppm before the Industrial Revolution to roughly 427 ppm in 2025, about a 50% increase. More greenhouse gas means more trapped heat, all the time, everywhere.</p>""" + GREENHOUSE_SVG,
        "worksheet": """
        <div class="ws-q">
    ...
    },
    {
        ...
        "summary": """<p>Most human-caused emissions come from burning fossil fuels for electricity, heat and transport. Industry, agriculture &amp; land use, and waste add the rest, roughly in that order of scale.</p>
        ...
        <div class="ws-q">
          ...
          <p>(Write 1 to 5 next to each: Waste, Transport, Electricity &amp; heat, Agriculture &amp; land use, Industry)</p>
    ...
    },
    {
        ...
        <p>In Nigeria, 2025 brought both extremes: devastating floods (Mokwa, Niger State, among the worst in decades) affecting roughly 15 million people at risk across 30 of 36 states, and, at the same time, severe heat past 40&deg;C in the north that disrupted planting season.</p>""",
        "worksheet": """
        <div class="ws-q">
    ...
    },
    {
        ...
        "summary": """<p>A carbon footprint adds up the greenhouse gases linked to your transport, electricity and food choices into one rough yearly number, usually in tonnes of CO2-equivalent. The rough global average is about 4.7 tonnes per person per year, transport, flights and generator use usually move the number the most.</p>""",
        "worksheet": """
        <div class="ws-q">
    ...
    },
    {
        ...
        "summary": """<p>Solar and wind convert sunlight and moving air directly into electricity, with no fuel burned during operation. Renewables reached about 34% of the world's electricity in 2025, up from roughly 23% a decade earlier. Nigeria sits in a sunny belt and already relies heavily on diesel generators, making off-grid solar a particularly direct, practical opportunity.</p>""",
        "worksheet": """
        <div class="ws-q">
    ...
    },
    {
        ...
        "summary": """<p>Understanding the problem is step one; doing something is step two. The Action Hub lists real, tickable actions across school, home, community, and future leadership, most of them free to start today.</p>""",
        "worksheet": """
        <div class="ws-q">
...
course_hero = hero_block(
    ...
    lede="The same site, walked through in order, one objective and one worksheet per lesson. Built for classrooms, but just as good for exploring solo at your own pace.",
...
<section class="section">
  <div class="wrap" style="max-width:820px;">
    ...
    <div class="callout callout--note reveal" style="margin-top:30px;">
      ...
      <p>The <a href="what-is-global-warming.html">Learn</a> and <a href="action-hub.html">Take Action</a> pages are still there for browsing freely in any order. This course is the same material, just sequenced with objectives, worksheets and a finish line, useful for a classroom, a homeschool unit, or anyone who wants a clear start-to-end path.</p>
    </div>
  </div>
</section>
""" % course_lesson_cards
...
teachers_hero = hero_block(
    ...
    h1="For Teachers",
    lede="A ready-to-use lesson plan for running this as a classroom unit, eight sessions, each with an objective, a discussion question, and a printable worksheet already built in.",
  ...
  <div class="wrap">
    ...
    <div class="grid grid-2 reveal">
      <div class="card">
        ...
        <p>Every lesson page has a built-in printable worksheet with a print button, no separate handouts to manage.</p>
      </div>
      <div class="card">
      ...
      <div class="card">
        ...
        <p>Lessons 3, 4 and 8 work especially well as small-group discussions rather than solo worksheet time, they're opinion- and reflection-heavy by design.</p>
      </div>
      <div class="card">
        <div class="ico">🔁</div><h3>Progress, honestly</h3>
        <p>"Mark complete" buttons save to each device's browser, not a shared gradebook, great for self-paced learning, but for a class roster you'll still want the check-in below.</p>
      </div>
    </div>

    <div class="prose reveal" style="margin-top:40px;">
      <h2>Setting up class check-ins (free, no card, GitHub-only)</h2>
      <p>Students can send their progress to you via the <a href="checkin.html">Check In</a> page, which opens a pre-filled GitHub Issue in your repo with their name and completed lessons. They click "Submit new issue" themselves; nothing is collected on the site, and you need no backend or paid service at all.</p>
      <ol>
        <li>Check-ins land in your repo's <strong>Issues</strong> tab, and automatically flow into the <a href="class-dashboard.html">Class Dashboard</a>, a free GitHub Action rebuilds it whenever an Issue changes (and every 6 hours as a fallback). Nothing to configure beyond the repo itself.</li>
        <li>Decide public vs. private for the repo. If your students are minors, either keep the repo private, or ask them to check in with a first name + initial instead of a full name; the check-in page already nudges them toward that.</li>
...
cert_hero = hero_block(
    ...
    lede="Finished all 8 lessons? Type a name below and download a certificate, a small, real way to mark finishing the course.",
...
checkin_hero = hero_block(
    ...
    lede="This sends your name and lesson progress to your teacher as a GitHub Issue, free, and nothing leaves this page until you choose to submit it on GitHub yourself.",
    ctas_html='<a href="course.html" class="btn btn-ghost">← Back to course</a>',
    media_html="", readout_cells=[
...
<section class="section">
  <div class="wrap" style="max-width:640px;">
    ...
    <div class="callout callout--note reveal">
      ...
      <p>You'll need a free GitHub account to actually submit this (most students who code already have one). Consider using just your first name and last initial, e.g. "Ada O.", rather than your full name, since this can be visible publicly.</p>
    </div>
...
dashboard_hero = hero_block(
    ...
    h1="Class Dashboard",
    lede="A live view of every student check-in, built automatically by a free GitHub Action that watches the repo's Issues, so you never have to read a raw Issues list by hand.",
...
<section class="section">
  <div class="wrap">
    ...
    <div class="callout callout--note reveal" style="margin-top:30px;">
      ...
      <p>Every time a check-in Issue is opened (or every six hours as a fallback), a free GitHub Action reads the repo's Issues, rebuilds <code>roster-data.json</code>, and commits it back, no server, no database, no cost. See <code>.github/workflows/update-dashboard.yml</code> and <code>scripts/build_roster.py</code> in the repo.</p>
    </div>
  </div>
</section>
"""
